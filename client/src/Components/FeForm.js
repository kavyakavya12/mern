...
function FeForm() {
    ...
    const feedback_type = {
        'qos': 'Please choose the venue which provide the service(venue) best.', 
        'qob': 'Please choose the venue which provide the best tasty and quality in beverage(or catering).',
        'roc': 'Please choose the venue which is cost efficient?',
        'exp': 'Please rate or chooose the best venue from your overall  experience.'
    };

    const feedback_opts = ['The Avenue', 'Paradise Gardens', 'Atlantis', 'The Blue Fin'];
